...
- existing pattern reused:
  ...
  - `generated/calculated_metric_formula_registry_canonical.csv`
- Metabase builder scripts family `scripts/create_metabase_*dashboard.py`
...
2. Run calculated metrics for the same weekly period:
   ...
   - `partner_commission`
3. Rebuild view:
   - [`scripts/rebuild_weekly_marketing_operational_view.py`](/Users/Peter/Documents/Morpheus%20Metrics/scripts/rebuild_weekly_marketing_operational_view.py)
4. Publish dashboard:
   - [`scripts/create_metabase_weekly_marketing_operational_dashboard.py`](/Users/Peter/Documents/Morpheus%20Metrics/scripts/create_metabase_weekly_marketing_operational_dashboard.py)
