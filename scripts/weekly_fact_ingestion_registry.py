...
def weekly_steps() -> Sequence[WeeklyIngestionStep]:
    return (
        WeeklyIngestionStep(
            ...
            script_path=SCRIPTS_DIR / "import_live_weekly_manual_to_fact.py",
            source_run_id="weekly_manual_live_v3",
            report_path=GENERATED_DIR / "live_weekly_manual_to_fact_import_report.csv",
            implemented=True,
        ...
        WeeklyIngestionStep(
            ...
            source_system="erp",
            script_path=SCRIPTS_DIR / "import_erp_weekly_to_fact.py",
            source_run_id="erp_weekly_v1",
            report_path=GENERATED_DIR / "erp_weekly_to_fact_import_report.csv",
            implemented=True,
        ...
        WeeklyIngestionStep(
            ...
            source_system="erp",
            script_path=SCRIPTS_DIR / "import_erp_salary_variable_weekly_to_fact.py",
            source_run_id="erp_salary_variable_weekly_v1",
            report_path=GENERATED_DIR / "erp_salary_variable_weekly_to_fact_import_report.csv",
            implemented=True,
        ...
        WeeklyIngestionStep(
            ...
            source_system="erp",
            script_path=SCRIPTS_DIR / "import_erp_survey_satisfaction_weekly_to_fact.py",
            source_run_id="erp_survey_satisfaction_weekly_v1",
            report_path=GENERATED_DIR / "erp_survey_satisfaction_weekly_to_fact_import_report.csv",
            implemented=True,
        ...
        WeeklyIngestionStep(
            ...
            script_path=SCRIPTS_DIR / "import_amocrm_weekly_to_fact.py",
            source_run_id="amocrm_weekly_v1",
            report_path=GENERATED_DIR / "amocrm_weekly_to_fact_import_report.csv",
            implemented=True,
        ...
        WeeklyIngestionStep(
            ...
            script_path=SCRIPTS_DIR / "import_yandex_metrica_weekly_to_fact.py",
            source_run_id="yandex_metrica_weekly_v1",
            report_path=GENERATED_DIR / "yandex_metrica_weekly_to_fact_import_report.csv",
            implemented=True,
        ...
        WeeklyIngestionStep(
            ...
            source_system="yandex_metrica",
            script_path=SCRIPTS_DIR / "import_yandex_metrica_tracked_purchase_visits_weekly_to_fact.py",
            source_run_id="yandex_metrica_tracked_purchase_visits_weekly_v1",
            report_path=GENERATED_DIR / "yandex_metrica_tracked_purchase_visits_weekly_to_fact_import_report.csv",
            implemented=True,
        ...
        WeeklyIngestionStep(
            ...
            script_path=SCRIPTS_DIR / "import_yandex_direct_weekly_to_fact.py",
            source_run_id="yandex_direct_weekly_v1",
            report_path=GENERATED_DIR / "yandex_direct_weekly_to_fact_import_report.csv",
            implemented=True,
