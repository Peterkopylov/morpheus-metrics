...
def main() -> None:
    ...
    cards = [
        create_card(config, args.metabase_database_id, "TEMP ERP Sales KPI Moscow", query("b2c_moscow")),
        create_card(config, args.metabase_database_id, "TEMP ERP Sales KPI SPB", query("b2c_spb")),
    ]
    put_dashboard_cards(
        config,
        dashboard["id"],
