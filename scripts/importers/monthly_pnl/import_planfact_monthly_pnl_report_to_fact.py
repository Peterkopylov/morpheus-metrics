...
def main() -> None:
    ...
    parser.add_argument(
        "--report-path",
        default="/Users/Peter/Documents/Morpheus Metrics/artifacts/run_reports/planfact_monthly_pnl_report_to_fact_import_report.csv",
    )
                    ...
                    for idx, parsed_row in enumerate(parsed_rows):
                        ...
                        if has_children and should_alert_on_leaf_to_parent_change(label):
                            raise RuntimeError(
                                ...
                                "Update catalog/pnl_structure_mapping_canonical.csv and "
