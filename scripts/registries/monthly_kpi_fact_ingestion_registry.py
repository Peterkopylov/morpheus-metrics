...
IMPORTERS_DIR = ROOT / "scripts" / "importers" / "monthly_kpi"
...
def monthly_kpi_steps() -> Sequence[MonthlyKpiIngestionStep]:
    return (
        MonthlyKpiIngestionStep(
            ...
            source_system="erp",
            script_path=IMPORTERS_DIR / "import_erp_monthly_to_fact.py",
            source_run_id="erp_monthly_v1",
            report_path=REPORTS_DIR / "erp_monthly_to_fact_import_report.csv",
            implemented=True,
        ...
        MonthlyKpiIngestionStep(
            ...
            source_system="erp",
            script_path=IMPORTERS_DIR / "import_erp_salary_variable_monthly_to_fact.py",
            source_run_id="erp_salary_variable_monthly_v1",
            report_path=REPORTS_DIR / "erp_salary_variable_monthly_to_fact_import_report.csv",
            implemented=True,
        ...
        MonthlyKpiIngestionStep(
            ...
            source_system="erp",
            script_path=IMPORTERS_DIR / "import_erp_survey_satisfaction_monthly_to_fact.py",
            source_run_id="erp_survey_satisfaction_monthly_v1",
            report_path=REPORTS_DIR / "erp_survey_satisfaction_monthly_to_fact_import_report.csv",
            implemented=True,
        ...
        MonthlyKpiIngestionStep(
            ...
            script_path=IMPORTERS_DIR / "import_amocrm_monthly_to_fact.py",
            source_run_id="amocrm_monthly_v1",
            report_path=REPORTS_DIR / "amocrm_monthly_to_fact_import_report.csv",
            implemented=True,
        ...
        MonthlyKpiIngestionStep(
            ...
            script_path=IMPORTERS_DIR / "import_yandex_metrica_monthly_to_fact.py",
            source_run_id="yandex_metrica_monthly_v1",
            report_path=REPORTS_DIR / "yandex_metrica_monthly_to_fact_import_report.csv",
            implemented=True,
        ...
        MonthlyKpiIngestionStep(
            ...
            source_system="yandex_metrica",
            script_path=IMPORTERS_DIR / "import_yandex_metrica_tracked_purchase_visits_monthly_to_fact.py",
            source_run_id="yandex_metrica_tracked_purchase_visits_monthly_v1",
            report_path=REPORTS_DIR / "yandex_metrica_tracked_purchase_visits_monthly_to_fact_import_report.csv",
            implemented=True,
        ...
        MonthlyKpiIngestionStep(
            ...
            script_path=IMPORTERS_DIR / "import_yandex_direct_monthly_to_fact.py",
            source_run_id="yandex_direct_monthly_v1",
            report_path=REPORTS_DIR / "yandex_direct_monthly_to_fact_import_report.csv",
            implemented=True,
