...
FORMULA_REGISTRY_PATH = ROOT / "calculated" / "formula_registry.csv"
FACT_SOURCE_OF_TRUTH_PATH = ROOT / "fact" / "source_of_truth.csv"
...
def resolve_dependency(
    ...
    return ResolvedDependency(
        ...
        notes="Resolved from active fact/source_of_truth.csv primary source row.",
    )
