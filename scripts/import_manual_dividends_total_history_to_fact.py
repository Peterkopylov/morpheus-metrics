...
DEFAULT_INPUT_CSV = ROOT / "generated/manual_dividends_total_history.csv"
DEFAULT_REPORT_CSV = ROOT / "generated/manual_dividends_total_history_import_report.csv"
SOURCE_SYSTEM = "manual_dividends_total_history"
SOURCE_RUN_ID = f"manual_dividends_total_history_{date.today().isoformat()}"
REFERENCE_DOC = "/Users/Peter/Documents/Morpheus Metrics/docs/manual_dividends_total_history.md"
