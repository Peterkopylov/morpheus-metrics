...
def main() -> None:
    ...
    cards = [
        create_card(config, args.metabase_database_id, collection_id, "Moscow Weekly Latest Comparison", comparison_query("b2c_moscow")),
        create_card(config, args.metabase_database_id, collection_id, "SPB Weekly Latest Comparison", comparison_query("b2c_spb")),
    ]
