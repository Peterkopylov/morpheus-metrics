...
def main():
    ...
    cards = [
        create_card(config, args.metabase_database_id, collection_id, "Moscow Weekly Metrics YoY Latest", latest_week_query("b2c_moscow"), "table"),
        create_card(config, args.metabase_database_id, collection_id, "SPB Weekly Metrics YoY Latest", latest_week_query("b2c_spb"), "table"),
        create_card(config, args.metabase_database_id, collection_id, "Moscow Weekly Metrics 6W Matrix", matrix_query("b2c_moscow"), "table"),
        create_card(config, args.metabase_database_id, collection_id, "SPB Weekly Metrics 6W Matrix", matrix_query("b2c_spb"), "table"),
        create_card(config, args.metabase_database_id, collection_id, "Moscow Weekly Metrics 6W Trend", trend_query("b2c_moscow"), "line"),
        create_card(config, args.metabase_database_id, collection_id, "SPB Weekly Metrics 6W Trend", trend_query("b2c_spb"), "line"),
    ]
